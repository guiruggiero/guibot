...
from fuhrerscheinstelle import check_for_appt as check_for_appt_fuherscheinstelle
from auslaenderamt import check_for_appt as check_for_appt_auslaenderamt
